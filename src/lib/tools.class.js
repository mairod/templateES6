...
export class AudioAnalyzer {
    ...
    addControlPoint(options) {
        ...
        if (options.bufferPosition > this.bufferLength) {
            ...
            console.log('Control point added at position ', control.frequency);
            control._data = {
                position: {
                    x: 0,
                    y: 0
            ...
            control.shift = function(frequency) {
                if (frequency != undefined) {
                    ...
                    console.log('Control point shifted at position ', frequency);
    ...
    updateControlPoint() {
        ...
        for (var i = 0; i < this.controls.length; i++) {
            ...
            control._data.position.x = (control._data.radius * control.frequency) + control._data.radius * 5;
            control._data.position.y = this.height - this.dataArray[dataFrequency] / 3;
